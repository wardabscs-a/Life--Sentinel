...
exports.command = new command_1.Command("dataconnect:execute [file] [operationName]")
    .description(`execute a SQL Connect query or mutation. If ${constants_1.Constants.FIREBASE_DATACONNECT_EMULATOR_HOST} is set (such as during 'firebase emulator:exec'), executes against the emulator instead.`)
