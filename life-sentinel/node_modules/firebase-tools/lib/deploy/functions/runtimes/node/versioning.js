...
exports.FUNCTIONS_SDK_VERSION_TOO_OLD_WARNING = exports.MIN_FUNCTIONS_SDK_VERSION_FOR_EXTENSIONS_FEATURES = exports.MIN_FUNCTIONS_SDK_VERSION = exports.FUNCTIONS_SDK_DEV_VERSION = void 0;
...
exports.FUNCTIONS_SDK_DEV_VERSION = "0.0.0-development";
exports.MIN_FUNCTIONS_SDK_VERSION = "3.20.0";
exports.MIN_FUNCTIONS_SDK_VERSION_FOR_EXTENSIONS_FEATURES = "5.1.0";
...
function checkFunctionsSDKVersion(currentVersion) {
    if (currentVersion === exports.FUNCTIONS_SDK_DEV_VERSION) {
        return;
    }
    try {
        if (semver.lt(currentVersion, exports.MIN_FUNCTIONS_SDK_VERSION)) {
