...
class Delegate {
    ...
    async discoverBuild(config, env) {
        if (this.sdkVersion === versioning.FUNCTIONS_SDK_DEV_VERSION) {
            logger_1.logger.debug("Skipping check for MIN_FUNCTIONS_SDK_VERSION for local development version.");
        }
            ...
            if (semver.lt(this.sdkVersion, versioning.MIN_FUNCTIONS_SDK_VERSION_FOR_EXTENSIONS_FEATURES)) {
