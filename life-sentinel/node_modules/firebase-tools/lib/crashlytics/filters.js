...
exports.EventFilterSchema = zod_1.z
    ...
    deviceDisplayNames: zod_1.z
        .array(zod_1.z.string())
        .optional()
        .describe(`Must be obtained from the *displayName* field in an API response. Only supported for mobile apps.`),
    deviceFormFactors: zod_1.z
        .array(zod_1.z.enum(["PHONE", "TABLET", "DESKTOP", "TV", "WATCH"]))
        .optional()
        .describe(`Counts events originating from the given device form factors. Only supported for mobile apps.`),
    browserFilterDisplayNames: zod_1.z
        .array(zod_1.z.string())
        .optional()
        .describe(`Counts events originating from the given browser filter display names. Only supported for web apps.`),
})
    .optional()
