...
exports.defaultComputeServiceAccountExists = defaultComputeServiceAccountExists;
...
async function verifyRuntimeServiceAccountAccess(projectId, serviceAccount) {
...
async function provisionDefaultComputeServiceAccount(projectId) {
    ...
    try {
        ...
        const status = (0, error_1.getErrStatus)(err);
        if (status === 400) {
            ...
            (0, utils_1.logWarning)("Failed to grant roles to the default App Hosting compute service account. Make sure you " +
...
async function defaultComputeServiceAccountExists(projectId) {
    try {
...
async function createDefaultComputeServiceAccount(projectId) {
    try {
        ...
        const status = (0, error_1.getErrStatus)(err);
        if (status === 403) {
            (0, utils_1.logWarning)("Failed to create the default App Hosting compute service account. Make sure you have " +
