...
exports.FIREBASE_MANAGED = exports.secretManagerConsoleUri = exports.SECRET_VERSION_NAME_REGEX = void 0;
...
const SECRET_NAME_REGEX = new RegExp("projects\\/" +
    ...
    "secrets\\/" +
    "(?<secret>[A-Za-z\\d\\-_]+)");
exports.SECRET_VERSION_NAME_REGEX = new RegExp(SECRET_NAME_REGEX.source + "\\/versions\\/" + "(?<version>latest|[0-9]+)");
...
function parseSecretVersionResourceName(resourceName) {
    const match = resourceName.match(exports.SECRET_VERSION_NAME_REGEX);
    if (!match?.groups) {
