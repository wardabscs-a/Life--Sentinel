...
exports.handleIncompatibleSchemaError = handleIncompatibleSchemaError;
    ...
    if (commandsToExecute.length) {
        ...
        if (commandsToExecuteByOwner.length) {
            if (experiments.isEnabled("fdcapimigration")) {
                (0, utils_1.logLabeledBullet)("dataconnect", `[EXPERIMENTAL] Delegating SQL execution to FDC Backend...`);
                const serviceName = serviceNameFromSchema(schema);
                await (0, client_1.executeSchemaMigration)(serviceName, commandsToExecuteByOwner);
            }
            else {
