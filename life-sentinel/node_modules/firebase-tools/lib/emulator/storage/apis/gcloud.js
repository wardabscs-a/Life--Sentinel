...
function createCloudEndpoints(emulator) {
    ...
    const postUploadMiddleware = (req, res, next) => {
        ...
        if (uploadType === "resumable" && !req.query.upload_id) {
            (0, express_1.json)({ limit: "130mb" })(req, res, next);
            return;
        }
    ...
    gcloudStorageAPI.patch("/b/:bucketId/o/:objectId", (0, express_1.json)({ limit: "130mb" }), async (req, res) => {
        let updatedMetadata;
        try {
    ...
    gcloudStorageAPI.put("/upload/storage/v1/b/:bucketId/o", bodyParser.raw({ type: "*/*", limit: "130mb" }), async (req, res) => {
    ...
    gcloudStorageAPI.post("/b/:bucketId/o/:objectId/acl", (0, express_1.json)({ limit: "130mb" }), async (req, res) => {
    ...
    gcloudStorageAPI.post("/upload/storage/v1/b/:bucketId/o", postUploadMiddleware, async (req, res) => {
        const uploadType = req.query.uploadType || req.header("X-Goog-Upload-Protocol");
    ...
    gcloudStorageAPI.post("/b/:bucketId/o/:objectId/:method(rewriteTo|copyTo)/b/:destBucketId/o/:destObjectId", (0, express_1.json)({ limit: "130mb" }), (req, res, next) => {
